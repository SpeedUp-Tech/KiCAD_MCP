...
export function registerSchematicTools(server, callKicadScript) {
    ...
    server.tool('load_schematic', toolDescription('load_schematic'), {
    ...
    server.tool('add_schematic_component', toolDescription('add_schematic_component'), {
    ...
    server.tool('update_schematic_component', toolDescription('update_schematic_component'), {
        schematicPath: z.string().describe('Path to the schematic file to update'),
    ...
    // }
    server.tool('remove_schematic_component', toolDescription('remove_schematic_component'), {
        schematicPath: z.string().describe('Path to the schematic file to update'),
    ...
    server.tool('add_schematic_wire', toolDescription('add_schematic_wire'), {
        schematicPath: z.string().describe('Path to the schematic file to update'),
    ...
    // }
    server.tool('remove_schematic_connection', toolDescription('remove_schematic_connection'), {
        schematicPath: z.string().describe('Path to the schematic file to update'),
    ...
    //   netConnections: string[]
    // }
    server.tool('connect_schematic_pins', toolDescription('connect_schematic_pins'), {
        schematicPath: z.string().describe('Path to the schematic file to update'),
        source: schematicConnectionPointSchema.describe('Source connection point - either a component pin {reference, pin} or label/power {label}'),
        target: schematicConnectionPointSchema.describe('Target connection point - either a component pin {reference, pin} or label/power {label}'),
    }, async ({ schematicPath, source, target }) => {
    ...
    server.tool('compile_schematic', toolDescription('compile_schematic'), {
    ...
    server.tool('run_module_erc', toolDescription('run_module_erc'), {
    ...
    server.tool('execute_skidl_netlist', toolDescription('execute_skidl_netlist'), {
    ...
    server.tool('execute_skidl_netlist_json', toolDescription('execute_skidl_netlist_json'), {
        skidlPath: z.string().describe('Path to the SKiDL Python file containing subcircuit definitions'),
        subcircuitName: z.string().optional().describe('Name of the @SubCircuit function to instantiate. If not provided, auto-detects from the module.'),
    }, async ({ skidlPath, subcircuitName }) => {
        const result = await callKicadScript('execute_skidl_netlist_json', {
            skidlPath,
            subcircuitName,
        });
        return formatToolResult(result);
    ...
    server.tool('export_schematic_pdf', toolDescription('export_schematic_pdf'), {
    ...
    server.tool('export_schematic_svg', toolDescription('export_schematic_svg'), {
        schematicPath: z.string().describe('Schematic file to export'),
    ...
    server.tool('run_erc', toolDescription('run_erc'), {
    ...
    server.tool('export_schematic_netlist', toolDescription('export_schematic_netlist'), {
    ...
    server.tool('export_schematic_bom', toolDescription('export_schematic_bom'), {
        schematicPath: z.string().describe('Schematic file to export from'),
    ...
    server.tool('generate_hierarchical_schematic', toolDescription('generate_hierarchical_schematic'), {
    ...
    server.tool('get_schematic_state', toolDescription('get_schematic_state'), {
