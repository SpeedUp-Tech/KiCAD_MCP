...
USE_CASE: Dict[str, Any] = {
    "name": "forward_conduction_drop_3A_25C",
    "mode": "auto",
    "given": {
        "VIN": {"dc_V": 4.0},
        "load": {"type": "const_current", "I_A": 3.0},
        "env": {"source_impedance_mohm": 50.0, "pack_esr_mohm": 50.0},
        "faults": {"initial_battery_voc_V": 3.9},
        "ambient": {"temp_C": 25.0},
    },
    "when": {"stabilize_ms": 5.0},
}
