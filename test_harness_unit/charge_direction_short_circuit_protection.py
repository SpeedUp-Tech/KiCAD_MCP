...
USE_CASE: Dict[str, Any] = {
    "name": "charge_direction_short_circuit_protection",
    "mode": "complex",
    "given": {
        "VIN": {"dc_V": 4.2},
        "load": {"type": "battery_model", "voc_V": 3.9, "esr_ohm": 0.05, "capacity_Ah": 2.0},
        "env": {"source_impedance_mohm": 50.0},
        "ambient": {"temp_C": 25.0},
        "faults": {"short_to_gnd_at_ms": 2.0, "short_res_ohm": 0.01},
    },
    "when": {"observe_window_ms": [0.0, 10.0]},
}
