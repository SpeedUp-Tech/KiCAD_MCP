...
USE_CASE: Dict[str, Any] = {
    "name": "steady_ripple_pass_through",
    "mode": "auto",
    "given": {
        "VIN": {"dc_V": 4.0, "ac_ripple_pp_V": 0.10, "ac_freq_kHz": 300.0},
        "load": {"type": "battery_model", "voc_V": 4.0, "esr_ohm": 0.05, "capacity_Ah": 2.0},
        "env": {"source_impedance_mohm": 50.0, "wiring_inductance_nH": 50.0},
        "ambient": {"temp_C": 25.0},
    },
    "when": {"observe_window_ms": [0.0, 5.0]},
}
